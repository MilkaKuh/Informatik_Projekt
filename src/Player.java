...
public class Player extends Character {
    ...
    public static int roundToTenner(int number) {
        int remainder = number % 10;

        // If the remainder is greater than or equal to 5, round up to the next ten
        if (remainder >= 5) {
            return number + (10 - remainder);
        } else {
            // Otherwise, round down to the previous ten
